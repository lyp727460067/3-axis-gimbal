...
extern uint8_t spi_dmp_write(uint8_t adrr, uint8_t reg, uint16_t lenth, uint8_t *date);
extern uint8_t spi_dmp_read(uint8_t adrr, uint8_t reg, uint16_t lenth, uint8_t *date);
extern void delay_ms(uint32_t n); 
	...
	#define i2c_write   spi_dmp_write //Sensors_I2C_WriteRegister
	#define i2c_read    spi_dmp_read  
